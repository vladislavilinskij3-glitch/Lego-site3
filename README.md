...
*   **CSS3** — Flexbox и Grid для адаптивных сеток, CSS-переменные для переключения тем (light/dark), медиазапросы для мобильных устройств, чтобы когда ширина экрана становится меньше 768 пикселей, сайт корректно отображался.
...
*   **Адаптивная верстка:** Сайт корректно отображается на ПК и мобильных устройствах.
...
*   **PWA и установка на устройство:** Сайт имеет файл манифеста, Service Worker и работает офлайн. На ПК и мобильных устройствах доступна установка  полноценного приложения (с собственной иконкой и отдельным окном а рабочем столе).
  ## Что не реализовано:
  *  Горизонтальное меню, потому что на сайте информация поступает пользователю плавно по мере скрола вниз, возможно добавлю, если сделаю сайт многостраничным или увеличу количество блоков с информацией.
  *  Пагинация и кнопка «Показать ещё», так как всего 7 услуг и максимум 4-5 преимуществ. Они идеально помещаются на одном экране без скролла
  *  Фильтры и сортировка товаров. Всего 7 направлений услуг, которые отлично видны без сортировки. Можно добавить если увеличиться набор услуг
  *   Интерактивная карта (Яндекс/Google Maps). Вместо карты просто дал текстовый адрес, чтобы не загромождать Лендинг. Если сделаю сайт многостраничным и усложню дизайн это будет уместно.
